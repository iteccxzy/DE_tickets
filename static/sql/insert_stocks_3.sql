-- PROCEDURE: public.insert_stock_3(integer, integer, integer)

-- DROP PROCEDURE public.insert_stock_3(integer, integer, integer);

CREATE OR REPLACE PROCEDURE public.insert_stock_3(
	office integer,
	plan integer,
	cantidad integer)
LANGUAGE 'sql'
...
INSERT INTO public.entry_stocks(
	st_date, st_time, office_id, plan_id, qt)  
	  ...
	  to_char(generate_series(20, 23) * interval '1 hour' + '2020-01-01 00:00:00'::timestamp, 'HH24:MI')::time,
	 office, 
	 plan, 
	 cantidad
